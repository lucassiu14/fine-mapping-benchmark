...
METHOD_ARGS <- list(
  ...
  # wall-clock. Users flagged that 500 iters is not enough for the
  # variational objective to stabilise on realistic data; 1500 is the
  # setting used in BEATRICE's own paper experiments. Per-fit runtime
  # at p = 1000 is ~10-15 minutes; per task (2500 BEATRICE-family fits)
  # is the wall-clock dominant. Watch for canary timeouts and adjust
  # only if the array hits the 72h walltime.
